    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="flex-1 p-6 overflow-auto">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-xl font-bold">📝 Surat Keterangan Usaha</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-4 rounded shadow">
            ...
            <p className="text-xs text-gray-500 mb-4">Data usaha yang dijalankan</p>
            <div className="grid grid-cols-2 gap-4 mb-2">
              <input type="text" placeholder="Nama Usaha" className="col-span-2 border px-3 py-2 rounded" defaultValue="" />
              <input type="text" placeholder="Jenis Usaha" className="col-span-2 border px-3 py-2 rounded" defaultValue="" />
              <input type="text" placeholder="Alamat Usaha" className="col-span-2 border px-3 py-2 rounded" defaultValue="" />
              <input type="text" placeholder="Tahun Berdiri" className="border px-3 py-2 rounded" defaultValue="" />
              <input type="text" placeholder="Status Tempat" className="border px-3 py-2 rounded" defaultValue="" />
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded shadow">
            ...
            <textarea className="w-full border px-3 py-2 rounded mb-2" rows={3} placeholder="Contoh: Syarat pengajuan pinjaman ke bank" />
